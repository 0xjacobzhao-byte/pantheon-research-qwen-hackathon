import type { MacroMiniPanelData } from "../api";

/**
 * MacroMiniPanel — context-only macro regime panel.
 * Sample / redacted / stale-safe. No investment advice. No false freshness.
 */

export default function MacroMiniPanel({ data }: { data: MacroMiniPanelData }) {
  return (
    <div className="mini-panel macro-mini" data-testid="macro-mini-panel">
      ...
      <div className="mini-regime">
        {Object.entries(data.regime).map(([key, val]) => (
